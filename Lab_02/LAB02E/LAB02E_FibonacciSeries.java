...
public class LAB02E_FibonacciSeries 
{
    ...
    public static void showFibonacciOf(int lastElement)
    {
        int n = 0 ; 
        int nplus1 = 1;
        // Initial valus of the fibonacci series
        
        int temp; // Temporary varible to store value of nplus1 while copying
        ...
        for(int i = 0 ; i < lastElement+1;i++)
        {
            ...
            nplus1 = n + nplus1; // make the new nplus1 to sumation of the two previous numbers
    ...
    public static int userInput()
    {
        ...
        do
        {
            ...
            System.out.println("Please enter the number of elements of the Finonacci Series ");
